...
const PAYMENTS_URL = '/api/v1/transactions';
...
const List = (props) => {
    ...
    return ( 
        <HomeLayout locale={locale} route_location='/home/transactions_list'>
            <PanelContainer>
                <PanelContainerView>
                    <div className="row">
                        {/* Top Header */}
                        <div className="row col-xs-12">
                            ...
                            <div className="col-xs-8">
                                <Typography size='h3'><I18n t="transactions_list" /></Typography>
                            </div>
